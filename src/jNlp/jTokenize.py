...
if __name__ == '__main__':
    ...
    parser.add_argument('-a', action="store", dest="action", type=str, help='-a base')
    parser.add_argument('-s', action="store", dest="sentence", type=str, help='-s Sentence')
    myarguments = parser.parse_args()
    print(cabocha(str(myarguments.sentence)))
    print(jReads(str(myarguments.sentence)))
